...
public class UserEntity extends BaseEntity {
    ...
    public List<AssignmentBuildingEntity> getBuildingAssignmnt() {
        return buildingAssignmnt;
    }

    public void setBuildingAssignmnt(List<AssignmentBuildingEntity> buildingAssignmnt) {
        this.buildingAssignmnt = buildingAssignmnt;
    }
