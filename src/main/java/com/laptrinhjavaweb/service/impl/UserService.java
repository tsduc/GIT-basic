...
public class UserService implements IUserService {
    ...
    @Override
    public List<StaffResponseDTO> assignmentStaffs(Long id) {
        List<UserEntity> staffs = userRepository.findByStatusAndRoles_Code(1, "STAFF");
        ...
        for (UserEntity item: staffs){
            ...
            AssignmentBuildingEntity assignmentBuildingEntity = assignmentBuildingRepository.findByBuilding_IdAndUser_Id(id, item.getId());
